 ...
 */
metadata {
	definition (name: "Fibaro Flood Sensor zw3", namespace: "ClassicGOD", author: "Artur Draga") {	
		...
		fingerprint mfr:"010F", prod:"0B00", model:"1001", zwv:"3.42"
		fingerprint mfr:"010F", prod:"0B00", model:"1001", zwv:"3.52"
	...
	tiles (scale: 2) {
		...
		main "FGFS"
		details(["FGFS","tamper","temperature","battery","temperatureAlarm"])
	}
		
	preferences {
		
 		input (
			title: "Fibaro Flood Sensor zw3",
			description: "Tap to view the manual.",
			image: "http://manuals.fibaro.com/wp-content/uploads/2017/05/dws2.jpg",
			url: "https://manuals.fibaro.com/content/manuals/en/FGFS-101/FGFS-101-EN-A-v1.00.pdf",
			type: "href",
			element: "href"
		)
...
def zwaveEvent(physicalgraph.zwave.commands.sensoralarmv1.SensorAlarmReport cmd) {
	...
	switch (cmd.sensorType) {
		case 0:
			sendEvent(name: "tamper", value: (cmd.sensorState == 255) ? "detected" : "clear")
			if ( cmd.sensorState == 255 ) { multiStatusEvent("Tamper - $lastTime") }
			break
		case 5:
			sendEvent(name: "water", value: (cmd.sensorState == 255) ? "wet" : "dry")
			if ( cmd.sensorState == 255 ) { multiStatusEvent("Water Detected - $lastTime") }
			break
		default: 
...
private Map cmdVersions() {
	[0x30: 2, 0x9C: 1, 0x60: 3, 0x85: 2, 0x8E: 2, 0x72: 2, 0x70: 2, 0x86: 1, 0x80: 1, 0x84: 2, 0x7A: 3]
}
